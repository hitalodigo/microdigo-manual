                ...
                <C.Row>
                    ...
                    <S.SidebarExampleContainer>
                        <div className="components">
                            <C.Title size="24">Os componentes</C.Title>
                        ...
                        <div className="selected-component">
                            <C.Title size="24">Selecionar tipo do componente</C.Title>
                            <p>
                ...
                <C.Row>
                    <S.ButtonDescriptionContainer>
                        <S.ButtonDescriptionItem
                            className='entry'
                        >
                            <C.Title size='20'>Entrada</C.Title>
                            <C.Paragraph size='12'>
                        ...
                        >
                            <C.Title size='20'>Condicionais</C.Title>
                            <C.Paragraph size='12'>
                        ...
                        <S.ButtonDescriptionItem
                            className='events'
                        >
                            <C.Title size='20'>Eventos</C.Title>
                            <C.Paragraph size='12'>
